...
function AllForms() {
    ...
    return (
        <div className="p-6 bg-gray-100 h-screen lg:flex justify-center items-center">
      ...
      <tbody className="divide-y divide-gray-200">
        {getAllForms.map((form, index) => (
          <tr key={form.id} className="hover:bg-gray-50 transition-all">
            ...
            <td className="p-4">
              <span
                className={`px-4 py-2 rounded-lg text-sm font-semibold shadow-md border 
  ...
  {showModal && (
    <div className="fixed inset-0 h-screen flex items-center justify-center bg-opacity-100">
